...
trainset = torchvision.datasets.CIFAR10(root=r'/root/datasets/', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=bs, shuffle=True, num_workers=8)

testset = torchvision.datasets.CIFAR10(root=r'/root/datasets/', train=False, download=True, transform=transform_test)
